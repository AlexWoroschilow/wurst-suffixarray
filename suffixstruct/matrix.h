/*
 * 27 Aug 2001
 * rcsid = $Id: matrix.h,v 1.5 2007/02/12 17:03:55 tmargraf Exp $
 */
#ifndef MATRIX_H
#define MATRIX_H
...
void    kill_i_matrix ( int **matrix, size_t n_rows);
...
int **copy_i_matrix ( int **matrix, const size_t n_rows,
                        const size_t n_cols);
int ** resize_i_matrix (int **src, const size_t n_rows, 
        const size_t n_cols, const size_t d_rows, const size_t d_cols);
int **
