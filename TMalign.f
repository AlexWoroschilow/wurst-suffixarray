...
ccc   
     ...
     &        ' regions by rasmol:'
         ...
         write(*,*)
         write(*,*)'3. There are two TM-scores reported. You ',
...
********* extract rotation matrix based on TMscore8 ------------>
      ...
      do i=1,n8_al
       ...
       if(L.gt.3)then
         ...
         write(*,*)'-------- Rotation matrix to rotate Chain_1 to ',
     &        'Chain_2 ------'
         write(*,*)'m          t(m)         u(m,1)         u(m,2) ',
     &        '        u(m,3)'
         do i=1,3
            write(*,209)i,t(i),u(i,1),u(i,2),u(i,3)
         enddo
         write(*,*)'Code for rotating Chain_1 from (x,y,z) to (X,Y,Z):'
         write(*,*)'    do i=1,L'
...
***** setting parameters ************************************
      ...
      if(n_frag.gt.aL/3)n_frag=aL/3
      ns=20                     !tail length to discard
      if(ns.gt.aL/3)ns=aL/3
